...
export class Backend implements backendInterface {
    ...
    async createGameSession(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createGameSession(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllGameSessions(): Promise<Array<GameSessionView>> {
        if (this.processError) {
            try {
    ...
    async getGameSession(arg0: string): Promise<GameSessionView> {
        if (this.processError) {
            try {
    ...
    async updateTerritoryOwnership(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTerritoryOwnership(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateUnitPosition(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateUnitPosition(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
