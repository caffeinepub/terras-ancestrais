...
const controls = [
  {
    ...
    items: [
      {
        key: "Clique na unidade",
        desc: "Seleciona sua unidade (anel brilhante = selecionável)",
      },
      {
        key: "Clique novamente / Escape",
        desc: "Desseleciona a unidade atual",
      },
  ...
  },
  {
    ...
    items: [
      {
        key: "Selecione → Clique no mapa",
        desc: "Move a unidade para aquela posição",
      },
      {
        key: "Círculo amarelo",
        desc: "Mostra o alcance de movimento disponível",
      },
      {
        key: "Botão Mover",
        desc: "Ativa o modo de movimento; clique no destino",
      },
    ],
  },
  {
    ...
    items: [
      {
        key: "Selecione → Clique no inimigo",
        desc: "Ataca aquela unidade inimiga diretamente",
      },
      {
        key: "Botão Atacar",
        desc: "Ataca o inimigo mais próximo no alcance (100px)",
      },
      {
        key: "Botão Fortalecer",
        desc: "Defende posição — reduz dano em 50% por 2 turnos",
      },
    ],
  },
  {
    ...
    items: [
      {
        key: "Fique no território",
        desc: "Começa a capturá-lo automaticamente",
      },
      {
        key: "Barra de progresso",
        desc: "Mostra o progresso de captura abaixo do território",
      },
      {
        key: "Borda colorida",
        desc: "Indica qual equipe controla o território",
      },
    ],
  },
  {
    ...
    items: [
      {
        key: "Colonizadores",
        desc: "Capturar todos os territórios para vencer",
      },
      {
        key: "Povos Nativos",
        desc: "Impedir a colonização total até o tempo acabar",
      },
    ...
    >
      ...
      >
        ...
        <div className="sticky top-0 parchment-bg border-b border-sepia/30 px-6 py-4 flex items-center justify-between">
          <div>
            <h2 className="font-cinzel text-xl font-bold text-sepia">
              Como Jogar
            </h2>
            <p className="font-fell text-xs text-sepia/60 mt-0.5">
              Guia de Controles e Estratégia
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="p-6 space-y-5">
              ...
              <div className="space-y-1.5">
                {section.items.map((item) => (
                  ...
                  >
                    ...
                    <span className="font-fell text-sepia/70 pt-0.5">
                      {item.desc}
                    </span>
                  </div>
                ))}
          ...
          <div className="bg-ochre/15 border border-ochre/30 rounded-sm p-3 mt-4">
            <p className="font-cinzel text-xs font-bold text-ochre mb-1">
              💡 Dica Rápida
            </p>
            <p className="font-fell text-xs text-sepia/70">
              Suas unidades têm um anel brilhante pulsante. Selecione-as e
              clique dentro do círculo amarelo para mover. Clique diretamente em
              uma unidade inimiga para atacar!
            </p>
          </div>
        </div>
