    ...
    <div className="min-h-screen bg-gradient-to-b from-sepia to-parchment/20 flex flex-col">
      ...
      <header className="text-center py-8 px-4">
        <div className="flex justify-center gap-6 mb-4">
          ...
          <div>
            <h1
              className="font-cinzel text-4xl font-bold text-ochre tracking-wider"
              style={{ textShadow: "0 2px 8px rgba(0,0,0,0.5)" }}
            >
              Terras do Século XVI
            </h1>
            <p className="font-fell text-parchment/70 text-lg mt-1">
              RPG Estratégico Multiplayer 4v4
            </p>
          </div>
          <img
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-4 pb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-native-green/10 border-2 border-native-green/30 rounded-xl p-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <div>
                <h2 className="font-cinzel text-lg font-bold text-native-green">
                  🛖 Povos Nativos
                </h2>
                <p className="text-xs text-parchment/60">
                  Mobilidade, resistência e conhecimento do território
                </p>
              </div>
            </div>
            <div className="space-y-2">
              {slots
                .filter((s) => s.team === "NativePeoples")
                .map((slot, i) => (
                  <PlayerSlotCard
                    key={slot.id}
                    slot={slot}
          ...
          <div className="bg-colonizer-red/10 border-2 border-colonizer-red/30 rounded-xl p-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <div>
                <h2 className="font-cinzel text-lg font-bold text-colonizer-red">
                  🏴‍☠️ Colonizadores
                </h2>
                <p className="text-xs text-parchment/60">
                  Organização, poder bélico e construção
                </p>
              </div>
            </div>
            <div className="space-y-2">
              {slots
                .filter((s) => s.team === "Colonizers")
                .map((slot, i) => (
                  <PlayerSlotCard
                    key={slot.id}
                    slot={slot}
        ...
        <div className="bg-parchment/5 border border-parchment/20 rounded-xl p-4 mb-6">
          <h3 className="font-cinzel text-sm font-bold text-ochre mb-3">
            📜 Regras da Partida
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs text-parchment/70 font-fell">
            <div>
              <p className="font-bold text-parchment/90 mb-1">
                🏆 Vitória dos Colonizadores
              </p>
              <p>
                Controlar Aldeia, Rio e Forte simultaneamente por 10 minutos
                contínuos.
              </p>
            </div>
            <div>
              <p className="font-bold text-parchment/90 mb-1">
                🛡️ Vitória dos Nativos
              </p>
              <p>
                Resistir até o tempo máximo da partida sem que os colonizadores
                completem o domínio.
              </p>
            </div>
            <div>
              ...
              <p>
                Ganhe XP, suba de nível e escolha caminhos de talentos durante a
                partida.
              </p>
            </div>
          </div>
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-parchment/40 mt-2 font-fell">
            {nativeSlots.length} Nativos vs {colonizerSlots.length}{" "}
            Colonizadores
          </p>
        </div>
      </main>
