    ...
    <div className="min-h-screen parchment-bg flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-4 left-4 w-16 h-16 opacity-30 pointer-events-none">
        <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
          <title>Ornamento decorativo</title>
          <path
            d="M4 4 L4 28 M4 4 L28 4 M4 4 L20 20"
            stroke="oklch(0.35 0.08 55)"
            strokeWidth="2"
          />
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(/assets/generated/map-background-v2.dim_1200x800.png)",
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 px-6 py-10 max-w-2xl w-full mx-4">
          ...
          <div className="flex flex-col items-center">
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, transparent, oklch(0.55 0.10 60), transparent)",
                }}
              />
              <p
        ...
        <div className="flex items-center gap-3 w-full max-w-sm">
          <div
            ...
            style={{ background: "oklch(0.55 0.10 60 / 0.5)" }}
          />
          <span
            className="period-text text-lg"
        ...
        >
          Dois povos. Um continente. Cada decisão moldará o destino das terras
          ancestrais. Escolha seu lado e escreva a história.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full max-w-sm">
          ...
          <button
            ...
            style={{
              ...
              letterSpacing: "0.08em",
              boxShadow:
                "0 4px 16px oklch(0.55 0.10 60 / 0.2), inset 0 1px 0 oklch(0.92 0.04 85 / 0.5)",
            }}
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLButtonElement).style.background =
